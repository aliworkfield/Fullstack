...
Revision ID: b2f95d2c6217
Revises: 0801e102be1a
Create Date: 2026-01-13 13:19:57.969242
...
revision = 'b2f95d2c6217'
down_revision = '0801e102be1a'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.create_index(op.f('idx_perm_ticket_requester'), 'resource_server_perm_ticket', ['requester'], unique=False)
    op.create_index(op.f('idx_perm_ticket_owner'), 'resource_server_perm_ticket', ['owner'], unique=False)
    ...
    sa.Column('organization_id', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('hide_on_login', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['realm_id'], ['realm.id'], name='fk2b4ebc52ae5c3b34'),
    sa.PrimaryKeyConstraint('internal_id', name='constraint_2b'),
    sa.UniqueConstraint('provider_alias', 'realm_id', name='uk_2daelwnibji49avxsrtuf6xj33', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    op.create_index(op.f('idx_idp_realm_org'), 'identity_provider', ['realm_id', 'organization_id'], unique=False)
    op.create_index(op.f('idx_idp_for_login'), 'identity_provider', ['realm_id', 'enabled', 'link_only', 'hide_on_login', 'organization_id'], unique=False)
    ...
    sa.UniqueConstraint('name', name='uk_orvsdmla56612eaefiq6wl5oi', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    ...
    sa.UniqueConstraint('realm_id', 'parent_group', 'name', name='sibling_names', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    ...
    sa.UniqueConstraint('name', 'resource_server_id', name='uk_frsrpt700s9v50bu18ws5ha6', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    ...
    sa.Column('group_id', sa.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('user_id', sa.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('membership_type', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    ...
    sa.UniqueConstraint('group_id', name=op.f('uk_org_group'), postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('realm_id', 'alias', name=op.f('uk_org_alias'), postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('realm_id', 'name', name=op.f('uk_org_name'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    op.create_index(op.f('user_attr_long_values_lower_case'), 'user_attribute', ['long_value_hash_lower_case', 'name'], unique=False)
    op.create_index(op.f('user_attr_long_values'), 'user_attribute', ['long_value_hash', 'name'], unique=False)
    ...
    op.create_index(op.f('idx_offline_uss_by_last_session_refresh'), 'offline_user_session', ['realm_id', 'offline_flag', 'last_session_refresh'], unique=False)
    op.create_index(op.f('idx_offline_uss_by_broker_session_id'), 'offline_user_session', ['broker_session_id', 'realm_id'], unique=False)
    ...
    sa.UniqueConstraint('name', 'owner', 'resource_server_id', name='uk_frsr6t700s9v50bu18ws5ha6', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    ...
    sa.UniqueConstraint('realm_id', 'client_id', name='uk_b71cjlbenv945rb6gcon438at', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    ...
    op.create_index(op.f('fed_user_attr_long_values_lower_case'), 'fed_user_attribute', ['long_value_hash_lower_case', 'name'], unique=False)
    op.create_index(op.f('fed_user_attr_long_values'), 'fed_user_attribute', ['long_value_hash', 'name'], unique=False)
    ...
    op.create_index(op.f('idx_client_att_by_name_value'), 'client_attributes', ['name', sa.literal_column('substr(value, 1, 255)')], unique=False)
    ...
    sa.UniqueConstraint('realm_id', 'email_constraint', name='uk_dykn684sl8up1crfei6eckhd7', postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('realm_id', 'username', name='uk_ru8tt6t700s9v50bu18ws5ha6', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    ...
    sa.PrimaryKeyConstraint('id', 'name', name=op.f('ORG_DOMAIN_pkey'))
    )
    op.create_index(op.f('idx_org_domain_org_id'), 'org_domain', ['org_id'], unique=False)
    ...
    sa.Column('id', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('expire', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('constraint_rt'))
    )
    op.create_index(op.f('idx_rev_token_on_expire'), 'revoked_token', ['expire'], unique=False)
    ...
    sa.UniqueConstraint('realm_id', 'name', name='uk_cli_scope', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    ...
    op.create_index(op.f('idx_usconsent_scope_id'), 'user_consent_client_scope', ['scope_id'], unique=False)
    ...
    sa.UniqueConstraint('client_id', 'user_id', name=op.f('uk_local_consent'), postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('client_storage_provider', 'external_client_id', 'user_id', name=op.f('uk_external_consent'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
