...
Revision ID: cf660b7b4af9
Revises: 2448698febe6
Create Date: 2026-01-05 14:19:45.890563
...
def upgrade():
    ...
    op.drop_index(op.f('user_attr_long_values'), table_name='user_attribute')
    op.drop_index(op.f('user_attr_long_values_lower_case'), table_name='user_attribute')
    op.drop_table('user_attribute')
    op.drop_index(op.f('idx_rev_token_on_expire'), table_name='revoked_token')
    ...
    op.drop_index(op.f('idx_perm_ticket_owner'), table_name='resource_server_perm_ticket')
    op.drop_index(op.f('idx_perm_ticket_requester'), table_name='resource_server_perm_ticket')
    ...
    op.drop_index(op.f('idx_client_att_by_name_value'), table_name='client_attributes')
    ...
    op.drop_index(op.f('idx_offline_uss_by_broker_session_id'), table_name='offline_user_session')
    op.drop_index(op.f('idx_offline_uss_by_last_session_refresh'), table_name='offline_user_session')
    ...
    op.drop_index(op.f('fed_user_attr_long_values'), table_name='fed_user_attribute')
    op.drop_index(op.f('fed_user_attr_long_values_lower_case'), table_name='fed_user_attribute')
    ...
    op.drop_index(op.f('idx_usconsent_scope_id'), table_name='user_consent_client_scope')
    ...
    op.drop_index(op.f('idx_idp_for_login'), table_name='identity_provider')
    op.drop_index(op.f('idx_idp_realm_org'), table_name='identity_provider')
    ...
    op.drop_index(op.f('idx_org_domain_org_id'), table_name='org_domain')
...
def downgrade():
    ...
    sa.UniqueConstraint('client_id', 'user_id', name='uk_local_consent', postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('client_storage_provider', 'external_client_id', 'user_id', name='uk_external_consent', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    ...
    sa.UniqueConstraint('name', 'client_realm_constraint', name='UK_J3RWUVD56ONTGSUHOGM184WW2-2', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
